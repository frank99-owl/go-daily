...
P0-A / P0-B / P0-C / P0-D 已完成首轮落地，后续仍可按验证结果小步修正。当前执行项是 P2-C。
...
P2-A / P2-B 已完成首轮落地。当前执行项是 P2-C：生产烟测。

P2-C 本轮目标是补齐可在本地重复运行的生产烟测：关键页面/API smoke、性能预算、SEO、PWA/offline、错误体验、邮件 dry-run 与 Stripe 本地校验。非目标：不部署、不真实发送邮件、不真实创建 Stripe 支付、不访问或修改外部系统。
