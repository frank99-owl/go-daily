...
- **`lib/localized.ts`**：回退链 `en → zh → ja → ko`，新语言加入时需更新 `FALLBACK_ORDER`。
...
*相关文档：[architecture.md](./architecture.md) · [data-schema.md](./data-schema.md) · [puzzle-authoring.md](./puzzle-authoring.md)*
