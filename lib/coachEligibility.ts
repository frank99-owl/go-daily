...
function buildResult(
  ...
  return {
    ...
    averageNoteLength: opts.averageNoteLength,
    explanationLocaleCount: opts.explanationLocaleCount ?? 0,
    genericLocaleCount: opts.genericLocaleCount ?? 0,
    hasVariationSupport: opts.hasVariationSupport,
