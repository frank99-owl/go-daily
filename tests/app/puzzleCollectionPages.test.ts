...
describe("puzzle collection pages", () => {
  ...
  it("builds static params and metadata for tag collections", async () => {
    const page = await import("@/app/puzzles/tags/[tag]/page");
