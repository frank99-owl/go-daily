...
describe("queueContent", () => {
  ...
  const mockPuzzles: Puzzle[] = [
    ...
    },
    {
      ...
      solutionNote: explainedNote,
      solutionSequence: [{ x: 8, y: 7, color: "black" }],
      source: "Library",
    },
    {
      id: "dup-a-001",
    ...
    },
    {
      ...
      solutionSequence: [
        ...
        { x: 12, y: 12, color: "white" },
      ],
      wrongBranches: [
        {
          userWrongMove: { x: 10, y: 10 },
          refutation: [{ x: 12, y: 11, color: "black" }],
          note: {
