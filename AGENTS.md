...
**Other Markdown**: root `README.md` / localized `README.*`, `CONTRIBUTING*.md`, `CHANGELOG.md`, `SECURITY.md`; `docs/en/UPGRADE_v1.1.md` (historic closure notes with post‑v1.1 addendum). **`reports/**/_.md`**: regenerated by npm scripts (`queue:content`, `report:_`) — snapshots only, not hand-maintained product specs (`docs/README.md`).
